...
//		Intent intent = Intent.getIntent("intent://map/direction?origin=latlng:34.264642646862,108.95108518068|name:我家&destination=大雁塔&mode=driving&region=西安&src=yourCompanyName|yourAppName#Intent;scheme=bdapp;package=com.baidu.BaiduMap;end");
		Intent intent = Intent.getIntent("intent://map/direction?origin=latlng:39.991255,116.514222|name:我的位置&destination=latlng:39.904899,116.499342|name:北京朝阳区百子湾12号大成国际公寓3号楼&coord_type=bd09&mode=driving&referer=com.menu|menu&src=tujia|tujia#Intent;scheme=bdapp;package=com.baidu.BaiduMap;end");
